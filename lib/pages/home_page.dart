...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        //bu appbar bn bodyni o'rtasidagi soyani yo'qotadi
        elevation: 0,
        backgroundColor: Color(0xFF018197),
        title: Row(
          //bu 2 ta containerlani 2 tomonga surib tashlaydi
      ...
      //amazon logodan oldingi menu iconni chu chiqaradi
      drawer: Drawer(),
      body: Container(
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          //kvadrat hosil bo'lishi uchun telni
                          // bo'yiga enini uzunligini berdik
